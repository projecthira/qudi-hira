...
__signature__ = 0x8f7847541f7427da0cb7f9c839ded155
...
def getmaxnumvalues(gcs):  # 'getmaxnumvalues' is too complex. pylint: disable=R1260
...
class Datarecorder(object):
    ...
    def maxnumvalues(self):
        ...
        if self._cfg['maxnumvalues'] is None:
            self._cfg['maxnumvalues'] = getmaxnumvalues(self._gcs)
