...
class PulsedMeasurementGui(GUIBase):
    ...
    def _create_pm_global_params(self):
        ...
        for param, value in self.pulsedmasterlogic().generation_parameters.items():
            ...
            # editor tab.
            if param in ('laser_channel', 'sync_channel', 'gate_channel', 'sweep_channel', 'next_channel'):
                continue
    ...
    def microwave_settings_changed(self):
        ...
        use_ext_sweep_microwave = self._pa.ext_control_use_mw_sweep_CheckBox.isChecked()

        settings_dict = dict()
        settings_dict['use_ext_microwave'] = use_ext_microwave
        settings_dict['use_ext_sweep_microwave'] = use_ext_sweep_microwave
