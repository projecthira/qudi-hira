...
class TimeTaggerODMRCounter(Base, ODMRCounterInterface):
    ...
    _pulsed_timetagger_channel_trigger_start = ConfigOption('pulsed_timetagger_channel_trigger_start', missing='error')
    _pulsed_timetagger_channel_trigger_stop = ConfigOption('pulsed_timetagger_channel_trigger_stop', missing='error')
